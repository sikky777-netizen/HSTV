const CACHE='tv-calculator-v4';
const ASSETS=['./','./index.html','./privacy.html','./styles.css','./app.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./assets/tv_install_320x80.png','./assets/og-tv-calculator.png'];
